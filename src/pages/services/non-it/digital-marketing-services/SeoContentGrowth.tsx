...
const item = {
  ...
  "title": "SEO Services",
  "shortDesc": "Technical SEO, on-page optimization, content strategy, and ongoing SEO management for sustainable rankings."
};
const heroImage = "/non-it-hero/seo-content-growth.png";
const content: any = {
  "heroTitle": "SEO Services for Organic Growth",
  "heroSubtitle": "Zora Global AI Technologies is an SEO agency delivering professional search engine optimization services that help businesses improve rankings, drive organic traffic, and build long-term brand visibility.",
  "primaryCta": "Get SEO Started",
  "secondaryCta": "Talk to Us",
  "topBlocks": [
    {
      "title": "Technical & On-Page SEO",
      "desc": "Website structure, page speed, indexing, metadata, content, and internal linking optimized for search performance."
    },
    {
      "title": "Content & Keyword Strategy",
      "desc": "Keyword research and content optimization targeting high-intent queries to drive qualified organic traffic."
    },
    {
      "title": "Local, Enterprise & Ecommerce SEO",
      "desc": "Scalable SEO solutions for local businesses, enterprises, SaaS, and ecommerce platforms."
    }
  ],
  "overview": "Our SEO services help businesses rank higher on Google, attract qualified organic traffic, and improve online visibility through technical SEO, on-page SEO, content optimization, local SEO, and ongoing management.",
  "deliverTitle": "How Our SEO Services Work",
  "deliverySteps": [
    {
      "title": "Audit — SEO Audit & Research",
      "desc": "Analyze website performance, competitors, keywords, technical issues, and content gaps."
    },
    {
      "title": "Optimize — Technical & Content SEO",
      "desc": "Implement fixes, on-page improvements, content optimization, and internal linking."
    },
    {
      "title": "Grow — Monitoring & SEO Growth",
      "desc": "Track rankings and traffic while continuously refining strategies."
    }
  ],
  ...
  "whyChoose": [
    {
      ...
      "desc": "Long-term strategy, not short-term spikes."
    },
    {
      "title": "Full-stack SEO",
      "desc": "Technical + on-page + content working together."
    },
    {
      "title": "Measurable tracking",
      "desc": "Rankings, traffic, and performance monitoring."
    }
  ],
  ...
  "contactSubtitle": "Ready to improve rankings and grow organic traffic? Speak with our SEO specialists today.",
