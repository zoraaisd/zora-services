...
const item = {
  ...
  "shortDesc": "Google Ads + Meta Ads campaigns to generate leads, increase conversions, and maximize ROI."
};
const heroImage = "/non-it-hero/performance-marketing.png";
const content: any = {
  "heroTitle": "Performance Marketing Services",
  "heroSubtitle": "Zora Global AI is a performance marketing agency delivering high-impact Google Ads and Meta Ads campaigns to generate qualified leads and measurable ROI.",
  "primaryCta": "Launch Paid Campaigns",
  "secondaryCta": "Talk to Us",
  "topBlocks": [
    {
      "title": "Google Ads & Search Marketing",
      "desc": "Search, display, remarketing, and conversion-focused PPC strategies."
    },
    {
      "title": "Meta Ads & Social Advertising",
      "desc": "Facebook and Instagram ad campaigns with targeting, creative testing, and conversion optimization."
    },
    {
      "title": "Conversion & ROI Optimization",
      "desc": "Optimize creatives, landing pages, bidding, and funnels to improve ROI and lower acquisition costs."
    }
  ],
  "overview": "Our performance marketing services focus on Google Ads, Facebook/Instagram Ads, and scalable paid acquisition models designed to increase conversions and maximize return on ad spend.",
  "deliverTitle": "How Our Performance Marketing Works",
  "deliverySteps": [
    {
      "title": "Plan — Audience & Funnel Strategy",
      "desc": "Research audiences, funnels, and competitors to build a data-driven paid advertising strategy."
    },
    {
      "title": "Launch — Ads Execution & Optimization",
      "desc": "Launch campaigns with optimized creatives, targeting, and bidding models."
    },
    {
      "title": "Scale — ROI Tracking & Growth",
      "desc": "Track CTR, CPA, ROAS and scale winning campaigns for consistent lead generation."
    }
  ],
  ...
  "whyChoose": [
    {
      "title": "ROI-focused",
      "desc": "Campaigns optimized for measurable growth and efficiency."
    },
    {
      "title": "Continuous optimization",
      "desc": "Iterate creatives, funnels, and bids to improve performance."
    },
    {
      "title": "Scalable lead flow",
      "desc": "Scale what works to create predictable results."
    }
  ],
  ...
  "contactSubtitle": "Looking to generate leads fast with Google Ads and Meta Ads? Talk to our performance marketing experts today.",
