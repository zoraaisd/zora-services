...
const item = {
  ...
  "shortDesc": "End-to-end social media management: strategy, content creation, scheduling, engagement, and analytics."
};
const heroImage = "/non-it-hero/social-media-branding.png";
const content: any = {
  "heroTitle": "Social Media Management Services",
  "heroSubtitle": "Zora Global AI provides end-to-end social media management services to help brands build awareness, engage audiences, and grow their online presence across major platforms.",
  "primaryCta": "Grow on Social Media",
  "secondaryCta": "Talk to Us",
  "topBlocks": [
    {
      "title": "Social Media Strategy",
      "desc": "Data-driven strategies aligned with brand goals, audience behavior, and platform best practices."
    },
    {
      "title": "Content Creation & Scheduling",
      "desc": "Creative posts, visuals, captions, and consistent scheduling across platforms."
    },
    {
      "title": "Community & Campaign Management",
      "desc": "Active engagement, moderation, and campaign execution to build trust and loyalty."
    }
  ],
  "overview": "Our social media management services connect businesses with their audience through consistent content, strategic campaigns, and active engagement, driving brand visibility and measurable growth.",
  "deliverTitle": "Our Social Media Management Process",
  "deliverySteps": [
    {
      "title": "Research — Audience & Platform Analysis",
      "desc": "Analyze audience behavior, competitors, and platform insights to define the right content strategy."
    },
    {
      "title": "Execution — Content Publishing & Engagement",
      "desc": "Publish content, manage interactions, and actively engage with audiences."
    },
    {
      "title": "Optimization — Analytics & Performance Improvement",
      "desc": "Track metrics and continuously optimize campaigns for growth."
    }
  ],
  ...
  "whyChoose": [
    {
      ...
      "desc": "A repeatable process to maintain brand visibility."
    },
    {
      "title": "Engagement growth",
      "desc": "Community management that builds trust and loyalty."
    },
    {
      "title": "Measurable insights",
      "desc": "Analytics-driven improvements to campaigns."
    }
  ],
  ...
  "contactSubtitle": "Ready to grow your brand on social media? Our experts are here to help.",
