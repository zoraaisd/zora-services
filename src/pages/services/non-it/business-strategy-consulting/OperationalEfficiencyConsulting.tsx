...
const item = {
  ...
  "shortDesc": "Eliminate inefficiencies, maximize productivity, and implement KPI-driven improvements across operations."
};
const heroImage = "/non-it-hero/operational-efficiency-consulting.png";
const content: any = {
  "heroTitle": "Operational Efficiency Consulting",
  "heroSubtitle": "Zora Global AI helps organizations optimize operations, eliminate inefficiencies, and maximize productivity through data-driven operational consulting.",
  ...
  "overview": "Our operational efficiency consulting services identify bottlenecks, streamline workflows, and implement sustainable improvements that drive measurable business results.",
  ...
  "whyChoose": [
    {
      ...
      "desc": "KPIs and dashboards to track improvements over time."
    },
    {
      "title": "Sustainable improvements",
      "desc": "Process changes that teams can adopt and maintain."
    },
    {
      "title": "Cost + productivity balance",
      "desc": "Reduce waste while protecting performance and compliance."
    }
  ],
  ...
  "contactSubtitle": "Ready to enhance efficiency and reduce costs? Our consultants are here to help you achieve operational excellence.",
