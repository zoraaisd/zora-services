...
const item = {
  ...
  "shortDesc": "Modernize processes and technology ecosystems through strategy, cloud, automation, data, and AI initiatives."
};
const heroImage = "/non-it-hero/digital-transformation-consulting.png";
const content: any = {
  "heroTitle": "Digital Transformation Consulting",
  "heroSubtitle": "Zora Global AI delivers digital transformation consulting services that help organizations modernize business processes, operational models, and technology ecosystems.",
  ...
  "overview": "Our digital transformation consulting services combine management consulting, IT consulting, and technology strategy to help businesses adapt, innovate, and scale through enterprise transformation initiatives.",
  ...
  "whyChoose": [
    {
      ...
      "desc": "From evaluation to roadmap to execution and optimization."
    },
    {
      "title": "Modern tech stack",
      "desc": "Cloud, automation, data, and AI combined with governance."
    },
    {
      "title": "Business-aligned change",
      "desc": "Transformation tied to outcomes, efficiency, and agility."
    }
  ],
  ...
  "contactSubtitle": "Ready to modernize your business? Talk to our digital transformation consultants today.",
