...
const item = {
  ...
  "shortDesc": "Talent acquisition, manpower services, operational staffing, administrative staffing, and customer support hiring."
};
const heroImage = "/non-it-hero/non-it-staff-augmentation.png";
const content: any = {
  "heroTitle": "Non-IT Staff Augmentation & Workforce Solutions",
  "heroSubtitle": "Zora Global AI provides non-IT staff augmentation services to support talent acquisition, manpower services, operational staffing, administrative staffing, and customer support hiring.",
  ...
  "overview": "Our non-IT staffing and workforce augmentation solutions help organizations meet staffing requirements efficiently across operations, administration, customer service, logistics, sales support, and management roles.",
  ...
  "whyChoose": [
    {
      "title": "Faster hiring",
      "desc": "Reduce hiring timelines with proven sourcing channels."
    },
    {
      "title": "Flexible models",
      "desc": "Temporary, contract, and long-term staffing options."
    },
    {
      "title": "Operational reliability",
      "desc": "Deployment + payroll + compliance support included."
    }
  ],
  ...
  "contactSubtitle": "Looking for reliable non-IT staffing and workforce augmentation? Connect with our staffing experts today.",
