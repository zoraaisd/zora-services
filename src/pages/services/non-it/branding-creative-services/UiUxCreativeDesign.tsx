...
const item = {
  ...
  "shortDesc": "User-focused digital experiences that improve usability, engagement, conversions, and brand perception."
};
const heroImage = "/non-it-hero/ui-ux-creative-design.png";
const content: any = {
  "heroTitle": "UI/UX Design Services",
  "heroSubtitle": "Zora Global AI designs intuitive, engaging, and user-focused digital experiences that improve usability, increase conversions, and strengthen brand perception.",
  "primaryCta": "Explore UI/UX Services",
  "secondaryCta": "Talk to Us",
  "topBlocks": [
    {
      "title": "User Research & Analysis",
      "desc": "Understand user behavior, needs, and pain points through research-driven insights."
    },
    {
      "title": "Interface Design",
      "desc": "Design visually appealing, intuitive interfaces aligned with usability best practices."
    },
    {
      "title": "Usability Testing",
      "desc": "Validate designs through testing, feedback, and continuous improvement cycles."
    }
  ],
  "overview": "Our UI/UX design services combine research, strategy, and creative design to deliver seamless digital experiences across web and mobile platforms.",
  "deliverTitle": "Our UI/UX Design Process",
  "deliverySteps": [
    {
      "title": "Research — User & Market Insights",
      "desc": "Research users, competitors, and product goals to define the design direction."
    },
    {
      "title": "Design — Wireframes & Visual Design",
      "desc": "Create wireframes, prototypes, and high-fidelity UI designs."
    },
    {
      "title": "Validate — Testing & Refinement",
      "desc": "Test usability, gather feedback, and refine designs for optimal user experience."
    }
  ],
  "whyChooseTitle": "Designing Experiences Users Love",
  "whyChoose": [
    {
      "title": "Clarity-first UX",
      "desc": "Reduce friction, improve navigation, and simplify journeys."
    },
    {
      "title": "Conversion-focused",
      "desc": "Design decisions that support engagement and outcomes."
    },
    {
      "title": "Validated results",
      "desc": "Testing and refinement for measurable UX improvements."
    }
  ],
  ...
  "contactSubtitle": "Ready to improve your digital product’s usability and design? Let’s build experiences your users will love.",
