...
const item = {
  ...
  "shortDesc": "Create distinctive and consistent brand identities with strategy, visual design, and scalable guidelines."
};
const heroImage = "/non-it-hero/brand-identity-positioning.png";
const content: any = {
  "heroTitle": "Brand Identity Design",
  "heroSubtitle": "Zora Global AI helps businesses create distinctive and consistent brand identities that connect emotionally with audiences and stand out in competitive markets.",
  ...
  "overview": "Our brand identity design services combine strategy, creativity, and visual design to build brands that are recognizable, meaningful, and scalable across all touchpoints.",
  "deliverTitle": "Our Brand Identity Process",
  "deliverySteps": [
    {
      "title": "Discover — Brand Research",
      "desc": "Understand your business, target audience, competitors, and market positioning."
    },
    {
      "title": "Design — Visual Identity Creation",
      "desc": "Design logos, color systems, typography, and supporting brand assets."
    },
    {
      "title": "Define — Guidelines & Rollout",
      "desc": "Deliver brand guidelines and support implementation across platforms and teams."
    }
  ],
  ...
  "whyChoose": [
    {
      ...
      "desc": "Positioning + messaging aligned to business goals."
    },
    {
      "title": "Recognizable identity",
      "desc": "Consistent visuals built for trust and recall."
    },
    {
      "title": "Scalable guidelines",
      "desc": "A system your team can apply everywhere."
    }
  ],
  ...
  "contactSubtitle": "Ready to create or refresh your brand identity? Let’s design a brand that truly represents your business.",
