...
const item = {
  ...
  "shortDesc": "Balance sheets, income statements, cash flow statements, compliance reporting, and analysis insights."
};
const heroImage = "/non-it-hero/financial-reporting.png";
const content: any = {
  "heroTitle": "Financial Reporting Services",
  "heroSubtitle": "Zora Global AI delivers accurate and compliant financial reporting services, helping businesses prepare balance sheets, income statements, profit and loss accounts, and cash flow statements with clarity and transparency.",
  "primaryCta": "Explore Financial Reporting",
  "secondaryCta": "Talk to Us",
  "topBlocks": [
    {
      "title": "Financial Statements",
      "desc": "Income statements, P&L, balance sheets, and cash flow statements prepared as per accounting standards."
    },
    {
      "title": "Management & Corporate Reporting",
      "desc": "Management accounting, consolidated reports, and internal performance reporting."
    },
    {
      "title": "Compliance & Financial Analysis",
      "desc": "Financial and ratio analysis with compliance to GAAP, IFRS, and statutory requirements."
    }
  ],
  "overview": "Our financial reporting services support businesses with accurate financial statements, trial balance review, statutory compliance, and financial analysis to deliver clear insights into performance and profitability.",
  "deliverTitle": "Our Financial Reporting Process",
  "deliverySteps": [
    {
      "title": "Collect — Financial Data Collection",
      "desc": "Collect trial balances, general ledger data, and accounting records."
    },
    {
      "title": "Prepare — Statement Preparation",
      "desc": "Prepare balance sheets, income statements, and cash flow statements."
    },
    {
      "title": "Review — Analysis & Compliance",
      "desc": "Perform analysis and ensure compliance with reporting standards."
    }
  ],
  ...
  "whyChoose": [
    {
      ...
      "desc": "Structured process for consistent financial statements."
    },
    {
      "title": "Compliance-first",
      "desc": "GAAP/IFRS + statutory alignment and review checks."
    },
    {
      "title": "Decision-ready insights",
      "desc": "Analysis that improves clarity on profitability and performance."
    }
  ],
  ...
  "contactSubtitle": "Need accurate financial statements or compliance-ready reports? Talk to our accounting experts today.",
