...
const item = {
  ...
  "shortDesc": "Daily transaction recording, ledger maintenance, reconciliations, and structured accounting records."
};
const heroImage = "/non-it-hero/bookkeeping-ledger-handling.png";
const content: any = {
  "heroTitle": "Bookkeeping & Ledger Handling",
  "heroSubtitle": "Zora Global AI provides reliable bookkeeping and ledger handling services focused on accurate recording of daily transactions, maintenance of general ledgers, and compliance with accounting standards.",
  "primaryCta": "Explore Bookkeeping Services",
  "secondaryCta": "Talk to Us",
  "topBlocks": [
    {
      "title": "Daily Transaction Recording",
      "desc": "Accurate recording of daily financial transactions using double entry bookkeeping principles and structured journal entries."
    },
    {
      "title": "General Ledger Management",
      "desc": "Maintenance of ledgers, chart of accounts, balances, and reconciliations for accuracy and consistency."
    },
    {
      "title": "Financial Accounting & Reporting",
      "desc": "Support for month-end close and reliable accounting reports aligned with standards."
    }
  ],
  "overview": "Our bookkeeping and ledger handling services cover financial accounting, journal entries, double entry bookkeeping, and general ledger management to ensure transparent and accurate financial records.",
  "deliverTitle": "Our Bookkeeping Process",
  "deliverySteps": [
    {
      "title": "Record — Transaction Recording",
      "desc": "Capture and record all business transactions using proper journal entries."
    },
    {
      "title": "Post — Ledger Posting",
      "desc": "Post journal entries to general ledger accounts and track balances accurately."
    },
    {
      "title": "Reconcile — Ledger Reconciliation",
      "desc": "Reconcile accounts, verify balances, and resolve discrepancies."
    }
  ],
  ...
  "whyChoose": [
    {
      ...
      "desc": "Structured entries and ledgers reduce compliance risks."
    },
    {
      "title": "Accurate reconciliations",
      "desc": "Verification of balances to prevent errors and leakage."
    },
    {
      "title": "Clear reporting",
      "desc": "Reliable financial records that support decisions."
    }
  ],
  ...
  "contactSubtitle": "Need reliable bookkeeping and ledger handling services? Speak with our accounting specialists today.",
