...
const content: any = {
  ...
  "heroSubtitle": "Scale development teams quickly with experienced engineers across web, mobile, cloud, and enterprise projects.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "Software Developers",
      "desc": "Frontend, backend, and full-stack engineers."
    },
    {
      "title": "Mobile Teams",
      "desc": "Android, iOS, and cross-platform experts."
    },
    {
      "title": "Specialized Talent",
      "desc": "DevOps, AI specialists, QA automation, and cloud engineers."
    }
  ],
  "overview": "Our staff augmentation model enables rapid onboarding of vetted developers who integrate seamlessly with your internal teams.",
  "deliverySteps": [
    {
      "title": "Planning",
      "desc": "Assess project scope and required skills."
    },
    {
      "title": "Onboarding",
      "desc": "Rapid hiring and developer integration."
    },
    {
      "title": "Delivery",
      "desc": "Agile collaboration and scalable team growth."
    }
  ],
  "whyChoose": [
    {
      "title": "Top Talent",
      "desc": "Access experienced engineers quickly."
    },
    {
      "title": "Flexible Engagement",
      "desc": "Scale teams based on project needs."
    },
    {
      "title": "Faster Delivery",
      "desc": "Accelerate timelines without compromising quality."
    }
  ],
