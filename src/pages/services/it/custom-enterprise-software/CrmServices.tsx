...
const heroImage = "/it-hero/crm.jpg";
const content: any = {
  "heroTitle": "CRM Services",
  "heroSubtitle": "Centralized CRM solutions that improve customer engagement, sales pipelines, and data-driven decision-making.",
  "primaryCta": "Build Your CRM",
  "topBlocks": [
    {
      "title": "Sales CRM",
      "desc": "Lead management, forecasting, and deal tracking systems."
    },
    {
      "title": "Marketing Automation",
      "desc": "Campaign automation and personalized customer journeys."
    },
    {
      "title": "Customer Support CRM",
      "desc": "Centralized ticketing and interaction tracking."
    }
  ],
  "overview": "Our CRM platforms help businesses manage relationships, automate workflows, and improve customer experiences through scalable CRM systems.",
  "deliverySteps": [
    {
      "title": "Discovery",
      "desc": "Analyze workflows and define CRM strategy."
    },
    {
      "title": "Configuration",
      "desc": "Customize modules, dashboards, and integrations."
    },
    {
      "title": "Optimization",
      "desc": "Deploy, train users, and continuously improve adoption."
    }
  ],
  "whyChoose": [
    {
      "title": "Tailored CRM",
      "desc": "Designed around real business workflows."
    },
    {
      "title": "Workflow Automation",
      "desc": "Improve efficiency across departments."
    },
    {
      "title": "Customer-Centric",
      "desc": "Enhance engagement and long-term loyalty."
    }
  ],
