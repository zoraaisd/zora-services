...
const heroImage = "/it-hero/recommendation.jpg";
const content: any = {
  "heroTitle": "AI Recommendation Systems",
  "heroSubtitle": "Personalized recommendations that increase engagement, conversions, and retention using machine learning and behavioral insights.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "Product Recommendations",
      "desc": "Personalize products based on behavior, purchases, and preferences."
    },
    {
      "title": "Content Recommendations",
      "desc": "Recommendations for video, learning, articles, and media platforms."
    },
    {
      "title": "Customer Personalization",
      "desc": "Segmentation + real-time personalization models for better experiences."
    }
  ],
  "overview": "We design collaborative filtering, content-based, and hybrid systems with real-time delivery and analytics-led improvements.",
  "deliverySteps": [
    {
      "title": "Discovery",
      "desc": "Use case and data analysis to define the right approach."
    },
    {
      "title": "Model Development",
      "desc": "Build recommendation models and validate quality metrics."
    },
    {
      "title": "Deployment",
      "desc": "Integrate into production and continuously optimize performance."
    }
  ],
  "whyChoose": [
    {
      "title": "ML Expertise",
      "desc": "Strong experience in data science and recommendation strategies."
    },
    {
      "title": "Real-Time Systems",
      "desc": "Built for scale with low-latency personalization."
    },
    {
      "title": "Business Impact",
      "desc": "Optimized for measurable outcomes like retention and conversions."
    }
  ],
