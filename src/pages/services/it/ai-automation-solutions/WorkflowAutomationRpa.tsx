...
const heroImage = "/it-hero/rpa.jpg";
const content: any = {
  "heroTitle": "Workflow Automation Solutions",
  "heroSubtitle": "Automate repetitive processes using intelligent workflows — improve speed, accuracy, and business agility.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "Business Process Automation",
      "desc": "Automate workflows across finance, HR, operations, and support."
    },
    {
      "title": "System & Tool Integration",
      "desc": "Connect CRMs, ERPs, databases, and third-party tools securely."
    },
    {
      "title": "Intelligent Automation",
      "desc": "Rule engines + AI logic to automate complex decisions."
    }
  ],
  "overview": "We streamline operations by connecting systems, data, and teams through secure automation. The result: reduced cost, fewer errors, and faster execution.",
  "deliverySteps": [
    {
      "title": "Discovery",
      "desc": "Process analysis and opportunity identification aligned to business goals."
    },
    {
      "title": "Design & Build",
      "desc": "Workflow design, integrations, approvals, triggers, and exception handling."
    },
    {
      "title": "Deploy & Scale",
      "desc": "Production deployment with monitoring, optimization, and scalability planning."
    }
  ],
  "whyChoose": [
    {
      "title": "Automation Expertise",
      "desc": "Deep integration and workflow engineering experience."
    },
    {
      "title": "Scalable & Secure",
      "desc": "Enterprise-grade automation with security at the core."
    },
    {
      "title": "Business-First Results",
      "desc": "Focused on measurable efficiency and faster execution."
    }
  ],
