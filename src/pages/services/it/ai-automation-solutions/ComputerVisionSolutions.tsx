...
const content: any = {
  ...
  "heroSubtitle": "Image and video intelligence with deep learning — detection, inspection, analytics, and automation built for real deployment.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "Image Recognition",
      "desc": "Classify objects, faces, and scenes using deep learning models."
    },
    {
      "title": "Video Analytics",
      "desc": "Real-time insights, tracking, behavior detection, and monitoring."
    },
    {
      "title": "Visual Inspection",
      "desc": "Detect defects and anomalies for manufacturing and industrial workflows."
    }
  ],
  "overview": "We build computer vision systems for real environments — with robust data pipelines, training workflows, deployment strategies, and continuous optimization.",
  "deliverySteps": [
    {
      "title": "Discovery",
      "desc": "Define use cases, data strategy, and model approach."
    },
    {
      "title": "Model Development",
      "desc": "Train and validate deep learning models for high accuracy."
    },
    {
      "title": "Deployment",
      "desc": "Deploy to production with monitoring and iterative improvements."
    }
  ],
  "whyChoose": [
    {
      "title": "Vision Expertise",
      "desc": "Strong experience across deep learning and visual intelligence."
    },
    {
      "title": "Production Ready",
      "desc": "Secure, scalable solutions for real-world deployment."
    },
    {
      "title": "Industry Use Cases",
      "desc": "Applications across healthcare, manufacturing, retail, and security."
    }
  ],
