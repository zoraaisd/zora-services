...
const content: any = {
  ...
  "heroSubtitle": "AI-powered chatbots that automate conversations, enhance customer engagement, and provide instant support across channels.",
  "primaryCta": "Build a Chatbot",
  "topBlocks": [
    {
      "title": "Customer Support Chatbots",
      "desc": "24/7 FAQ automation, ticket assistance, and real-time support."
    },
    {
      "title": "Sales & Lead Chatbots",
      "desc": "Lead qualification, meeting scheduling, and conversion support."
    },
    {
      "title": "Enterprise Internal Chatbots",
      "desc": "HR/IT onboarding, knowledge search, and productivity bots."
    }
  ],
  "overview": "We build business-ready conversational AI for websites, mobile apps, and internal platforms — with NLP, analytics, integrations, and continuous improvement.",
  "deliverySteps": [
    {
      "title": "Discovery",
      "desc": "Define use cases, user intents, and conversation flows."
    },
    {
      "title": "Development",
      "desc": "Build and train models for accurate responses and control."
    },
    {
      "title": "Deployment",
      "desc": "Integrate across platforms and optimize using real usage data."
    }
  ],
  "whyChoose": [
    {
      "title": "Practical AI",
      "desc": "Bots designed for business workflows — not just demos."
    },
    {
      "title": "Integration Ready",
      "desc": "CRM/helpdesk integration and omnichannel deployment."
    },
    {
      "title": "Continuous Improvement",
      "desc": "Analytics-led tuning for better outcomes over time."
    }
  ],
