...
const content: any = {
  ...
  "heroSubtitle": "Automation, predictive analytics, and personalization — production-ready ML systems engineered for scale and security.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "AI Automation",
      "desc": "Reduce manual effort and improve accuracy using ML-driven automation."
    },
    {
      "title": "Predictive Analytics",
      "desc": "Forecast trends and improve decisions using real-time ML models."
    },
    {
      "title": "Personalized Experiences",
      "desc": "Adaptive systems that personalize content, offers, and user journeys."
    }
  ],
  "overview": "We design ML solutions that are measurable, reliable, and maintainable — with structured training, evaluation, deployment, monitoring, and continuous improvement.",
  "deliverySteps": [
    {
      "title": "AI Discovery & Data Strategy",
      "desc": "Align objectives, data sources, and success metrics."
    },
    {
      "title": "Model Development & Training",
      "desc": "Build and train models with strong evaluation and security."
    },
    {
      "title": "Deployment & Optimization",
      "desc": "Deploy, monitor drift, and continuously improve quality."
    }
  ],
  "whyChoose": [
    {
      "title": "AI Expertise",
      "desc": "Deep ML engineering and data strategy for complex business use cases."
    },
    {
      "title": "Scalable & Secure",
      "desc": "Enterprise-grade data protection, monitoring, and performance."
    },
    {
      "title": "Business-Driven Strategy",
      "desc": "Focused on automation, accuracy, and measurable ROI."
    }
  ],
