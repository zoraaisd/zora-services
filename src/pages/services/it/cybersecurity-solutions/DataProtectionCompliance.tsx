...
const content: any = {
  ...
  "heroSubtitle": "Safeguard sensitive data and strengthen compliance readiness with encryption, controls, assessments, and continuous governance.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "Data Privacy & Protection",
      "desc": "Encryption, access controls, and secure handling practices."
    },
    {
      "title": "Compliance Readiness",
      "desc": "Assessments and controls aligned to common compliance frameworks."
    },
    {
      "title": "Testing & Risk",
      "desc": "Testing and risk management to reduce exposure and improve posture."
    }
  ],
  "overview": "We help organizations protect customer data, enterprise systems, and digital assets while improving compliance readiness using structured assessment, implementation, and monitoring.",
  "deliverySteps": [
    {
      "title": "Assessment",
      "desc": "Gap analysis across systems, policies, and data handling flows."
    },
    {
      "title": "Implementation",
      "desc": "Deploy controls and operational practices to reduce risk."
    },
    {
      "title": "Monitoring",
      "desc": "Ongoing governance, testing, and compliance management."
    }
  ],
  "whyChoose": [
    {
      "title": "Security + Compliance Expertise",
      "desc": "Practical controls with a compliance-friendly approach."
    },
    {
      "title": "Standards Aligned",
      "desc": "Built around common security and privacy expectations."
    },
    {
      "title": "Risk Reduction",
      "desc": "Reduce risk and increase trust with customers and stakeholders."
    }
  ],
