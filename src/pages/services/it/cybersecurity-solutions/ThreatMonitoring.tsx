...
const content: any = {
  ...
  "heroSubtitle": "Always-on monitoring to protect networks, endpoints, and cloud workloads using real-time detection and rapid response workflows.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "Network & Endpoint Monitoring",
      "desc": "Detect malware, anomalies, and suspicious activity in real time."
    },
    {
      "title": "Threat Intelligence",
      "desc": "Identify known and emerging threats using analytics and intel sources."
    },
    {
      "title": "Response & Mitigation",
      "desc": "Rapid containment and mitigation to reduce business impact."
    }
  ],
  "overview": "Our threat monitoring services provide continuous protection using detection pipelines, intelligence, and response playbooks — helping prevent incidents before they escalate.",
  "deliverySteps": [
    {
      "title": "Monitoring",
      "desc": "24/7 visibility across endpoints, networks, and cloud workloads."
    },
    {
      "title": "Detection",
      "desc": "Analyze signals, correlate events, and identify threats early."
    },
    {
      "title": "Response",
      "desc": "Contain threats quickly and implement mitigation actions."
    }
  ],
  "whyChoose": [
    {
      "title": "Advanced Monitoring",
      "desc": "Strong experience with detection, analysis, and response workflows."
    },
    {
      "title": "Proactive Security",
      "desc": "Early detection to reduce incident severity and downtime."
    },
    {
      "title": "Business Protection",
      "desc": "Designed to protect data, continuity, and operations."
    }
  ],
