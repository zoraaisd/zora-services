...
const content: any = {
  ...
  "heroSubtitle": "Comprehensive security audits to identify vulnerabilities, assess risks, and strengthen enterprise security across apps, networks, and cloud.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "Information & Network Audits",
      "desc": "Assess access controls, configurations, policies, and exposure."
    },
    {
      "title": "Vulnerability & Pen Testing",
      "desc": "Realistic testing to uncover exploitable weaknesses."
    },
    {
      "title": "Compliance & Risk",
      "desc": "Audit readiness aligned to common standards and regulations."
    }
  ],
  "overview": "We evaluate your organization’s security posture using structured audits, testing, and risk analysis — resulting in clear findings and actionable remediation.",
  "deliverySteps": [
    {
      "title": "Assessment",
      "desc": "Review systems, policies, configurations, and threat exposure."
    },
    {
      "title": "Testing",
      "desc": "Run vulnerability scans and penetration-style validation."
    },
    {
      "title": "Reporting",
      "desc": "Deliver clear reports with remediation priorities and guidance."
    }
  ],
  "whyChoose": [
    {
      "title": "Audit Expertise",
      "desc": "Experienced professionals delivering enterprise-grade assessments."
    },
    {
      "title": "Compliance Driven",
      "desc": "Approach aligned to common standards and audit expectations."
    },
    {
      "title": "Actionable Insights",
      "desc": "Clear, prioritized fixes that reduce risk quickly."
    }
  ],
