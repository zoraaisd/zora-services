...
const heroImage = "/it-hero/webapp.jpg";
const content: any = {
  "heroTitle": "Web Application Services",
  "heroSubtitle": "High-performance websites and scalable web applications designed to strengthen digital presence and support long-term business growth.",
  ...
  "overview": "We design and build web applications that are secure, scalable, and built for real operations. From portals and dashboards to full customer platforms, we deliver maintainable systems with strong UX and production-ready stability.",
  "deliverySteps": [
    {
