...
const content: any = {
  ...
  "heroSubtitle": "We build modern, scalable, and high-performing websites and web platforms — secure, responsive, and engineered for growth.",
  ...
  "overview": "Our web development services empower businesses with fast, reliable, and scalable digital solutions. From high-impact marketing sites to enterprise web apps, we build platforms that drive engagement, conversions, and long-term growth.",
  "deliverySteps": [
    {
      "title": "Planning",
  ...
  "contactSubtitle": "Ready to build or scale your web product? Tell us what you need and we’ll reach out.",
