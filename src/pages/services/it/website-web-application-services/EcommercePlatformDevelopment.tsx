...
const heroImage = "/it-hero/ecommerce.jpg";
const content: any = {
  "heroTitle": "E-Commerce Platform Development",
  "heroSubtitle": "Conversion-driven, secure e-commerce platforms built for scale — payments, inventory, and performance engineered in.",
  ...
  "overview": "We build scalable e-commerce platforms that support growth without breaking performance. From custom storefronts to integrated operations, we deliver secure shopping experiences with strong admin control and analytics-ready tracking.",
  "deliverySteps": [
    {
      "title": "Plan",
...
const ItWebsiteWebApplicationServicesEcommercePlatformDevelopment: React.FC = () => {
  useEffect(() => {
    window.scrollTo({
      top: 0,
      left: 0,
...
export default ItWebsiteWebApplicationServicesEcommercePlatformDevelopment;
