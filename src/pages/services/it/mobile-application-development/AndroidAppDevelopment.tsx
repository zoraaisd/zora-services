...
const content: any = {
  ...
  "heroSubtitle": "Secure, scalable, high-performance Android applications tailored to your business — built for smooth experiences across devices.",
  ...
  "overview": "Our Android app development services help businesses design, develop, and deploy powerful mobile applications with a strong focus on performance, security, maintainability, and Play Store readiness.",
  "deliverySteps": [
    {
      "title": "Planning",
      "desc": "Strategy, requirements, user journeys, and architecture planning."
    },
    {
      "title": "Development",
      "desc": "Engineering with secure coding and performance optimization."
    },
    {
      "title": "Launch",
      "desc": "Testing, compliance checks, and successful Play Store deployment."
    }
  ],
  "whyChoose": [
    {
      "title": "Android Expertise",
      "desc": "Skilled developers using modern Android toolchains and patterns."
    },
    {
      "title": "Scalable & Secure",
      "desc": "Apps engineered for growth, privacy, and reliability."
    },
    {
      "title": "End-to-End Delivery",
      "desc": "From planning to Play Store launch and post-release iteration."
    }
  ],
