...
const content: any = {
  ...
  "heroSubtitle": "Premium iOS applications for iPhone and iPad using Apple-native best practices — smooth UX, strong security, scalable foundations.",
  "primaryCta": "Build iOS App",
  "topBlocks": [
    {
      "title": "Custom iOS App Development",
      "desc": "Native iOS apps tailored to business goals and Apple standards."
    },
    {
      "title": "iOS UI/UX Design",
      "desc": "Elegant interfaces aligned with Apple Human Interface Guidelines."
    },
    {
      "title": "Apple Ecosystem Integration",
      "desc": "Secure integration with APIs, iCloud, and Apple services."
    }
  ],
  "overview": "Our iOS development services help businesses design, build, and launch high-quality mobile applications for the Apple ecosystem with performance, security, usability, and App Store compliance.",
  "deliverySteps": [
    {
      "title": "Planning",
      "desc": "Define goals, user journeys, and iOS-optimized architecture."
    },
    {
      "title": "Development",
      "desc": "Secure and scalable development using Apple-first best practices."
    },
    {
      "title": "Launch",
      "desc": "QA testing, App Store submission, and post-launch optimization."
    }
  ],
  "whyChoose": [
    {
      "title": "Apple Expertise",
      "desc": "Strong experience with iOS standards, UX, and compliance."
    },
    {
      "title": "Secure & Scalable",
      "desc": "Built for performance, security, and long-term growth."
    },
    {
      "title": "End-to-End Delivery",
      "desc": "From concept to App Store release with structured delivery."
    }
  ],
