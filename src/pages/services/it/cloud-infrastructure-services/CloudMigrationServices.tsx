...
const content: any = {
  ...
  "heroSubtitle": "Secure migration of applications, infrastructure, and data to modern cloud environments.",
  "primaryCta": "Start Your Migration",
  "topBlocks": [
    {
      "title": "Application Migration",
      "desc": "Rehost, refactor, or re-architect applications."
    },
    {
      "title": "Data Migration",
      "desc": "Secure database migration with validation and backups."
    },
    {
      "title": "Infrastructure Modernization",
      "desc": "Move on-premise workloads to scalable cloud platforms."
    }
  ],
  "overview": "We help organizations modernize legacy systems and adopt cloud-native architectures across AWS, Azure, and Google Cloud.",
  "deliverySteps": [
    {
      "title": "Assessment",
      "desc": "Define migration strategy and readiness."
    },
    {
      "title": "Migration",
      "desc": "Secure execution with minimal downtime."
    },
    {
      "title": "Optimization",
      "desc": "Performance and cost optimization."
    }
  ],
  "whyChoose": [
    {
      "title": "Multi-Cloud Expertise",
      "desc": "AWS, Azure, and Google Cloud specialists."
    },
    {
      "title": "Secure Migration",
      "desc": "Best practices for compliance and continuity."
    },
    {
      "title": "Business Alignment",
      "desc": "Strategies aligned with growth goals."
    }
  ],
