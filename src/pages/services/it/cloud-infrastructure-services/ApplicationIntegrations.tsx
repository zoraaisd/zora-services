...
const heroImage = "/it-hero/integrations.jpg";
const content: any = {
  "heroTitle": "Application Integrations",
  "heroSubtitle": "Connect enterprise systems and applications for seamless data flow and automation.",
  "primaryCta": "Get Started",
  "topBlocks": [
    {
      "title": "API Integrations",
      "desc": "Secure API and third-party integrations."
    },
    {
      "title": "Enterprise Integration",
      "desc": "Connect ERP, CRM, and business platforms."
    },
    {
      "title": "Process Automation",
      "desc": "Automate workflows through synchronized data."
    }
  ],
  "overview": "We unify enterprise systems into a connected ecosystem enabling real-time data exchange and operational efficiency.",
  "deliverySteps": [
    {
      "title": "Assessment",
      "desc": "Design optimal integration architecture."
    },
    {
      "title": "Integration",
      "desc": "Implement APIs and synchronization workflows."
    },
    {
      "title": "Optimization",
      "desc": "Monitoring and continuous improvement."
    }
  ],
  "whyChoose": [
    {
      "title": "Integration Expertise",
      "desc": "Deep enterprise system experience."
    },
    {
      "title": "Secure & Scalable",
      "desc": "Built for growth and compliance."
    },
    {
      "title": "Operational Efficiency",
      "desc": "Reduce manual work and errors."
    }
  ],
