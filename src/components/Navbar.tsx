  ...
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-10 py-3 flex justify-between items-center">
        ...
        {/* ================= DESKTOP NAV ================= */}
        <div className="hidden lg:flex flex-1 min-w-0 justify-end items-center gap-1 md:gap-1.5 xl:gap-3 2xl:gap-4 ml-2 xl:ml-4 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
